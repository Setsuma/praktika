...
namespace GUI
{
    public partial class OperatorForm : Form
    {
        ...
        public OperatorForm(string fullName, string role, int userid, Image photo)
        {
            InitializeComponent();
        ...
        private void btn_found_requests_by_user_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand command = new SqlCommand(query, database.GetConnection()))
            {
                ...
                int countbefore = dataGridView_all_requests_by_operator.Rows.Count;
                ...
                label_requests.Text = $"Количество записей: {recordCount} из {countbefore}";
